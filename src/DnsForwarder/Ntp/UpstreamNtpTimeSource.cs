...
{
    public sealed class UpstreamNtpTimeSource : ITimeSource, IAsyncDisposable
    {
        ...
        public DateTime ReferenceUtc => _referenceUtc;
        public int Stratum => _stratum;
        ...
        private async Task SyncOnceAsync(string server, CancellationToken ct)
        {
            ...
            ParseResponse(response.Buffer, sendTime, recvTime);
        }
